...
select opt in "${options[@]}"; do
	...
	"Bypass on Recovery")
        ...
        echo -e "${BLU}Press Enter to proceed to the next step. If left blank, default values will be used."
  		echo -e "Enter the user's real name (Default: User)"
		read realName
  		realName="${realName:=User}"
    	echo -e "${BLUE}Enter username ${RED}NO SPACES OR SPECIAL CHARACTERS ${GRN} (Default: user)"
      	read username
